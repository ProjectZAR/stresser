  ...
  <div class="login-box">
    ...
    <div class="white-box">
      ...
      <form class="form-horizontal form-material" id="loginform" method="post">
		...
		<div class="form-group">
          <div class="col-xs-12">
            <input class="form-control" type="text" name="register-refer" placeholder="Referrer (Optional)">
          </div>
        </div>
        <div class="form-group">
          <div class="col-md-12">
            <div class="checkbox checkbox-primary p-t-0">
              ...
              <label for="checkbox-signup"> I agree to all  <a type="submit" data-toggle="modal" data-target="#exampleModal" data-whatever="@mdo">Terms</a></label>
            </div>
          </div>
        </div>
        <div class="form-group text-center m-t-20">
          <div class="col-xs-12">
            <button name="doCreate" class="btn btn-info btn-lg btn-block text-uppercase waves-effect waves-light" type="submit">Sign Up</button>
          </div>
        </div>
